...
export class GameLogicService {
    ...
    private assignFirstPlayer(table: any): void {
        const firstPlayerPos = (table.dealerPosition + 3) % table.players.length;
        table.players.forEach((p: any) => p.isCurrentPlayer = false);
        table.players[firstPlayerPos].isCurrentPlayer = true;
    }
