...
export class GameLogicService {
    ...
    private async addLogEntry(table: any, type: 'action' | 'turn' | 'round' | 'cards' | 'pot', message: string, data?: any): Promise<void> {
        await this.gameLogService.addLogEntry(table.id, type, message, data);
    }

    initializeGame(table: any): any {
        await this.addLogEntry(table, 'round', 'Game initialized');
        ...
        await this.addLogEntry(table, 'round', `Round ${table.round} started`, { pot: table.pot });
