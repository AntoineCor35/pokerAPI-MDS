...
import { ActionLogEntry } from '../tables/dto/tables.dto';
...
export class GameLogicService {
    ...
    initializeGame(table: any): any {
        ...
        // Réinitialiser les logs d'action au début d'une nouvelle partie
        table.actionLogs = [];
    ...
    evaluateGameState(table: any): any {
        ...
        if (currentPlayer.isAI) {
            ...
            // Enregistrer l'action de l'IA dans les logs
            this.logAction(table, currentPlayer, action.type, action.amount);
    ...
    // Nouvelle méthode pour enregistrer les actions dans les logs
    private logAction(table: any, player: any, actionType: string, amount?: number): void {
        if (!table.actionLogs) {
            table.actionLogs = [];
        }
        ...
        table.actionLogs.push(logEntry);
    }
    ...
    private evaluateEndRound(table: any): any {
        ...
        // Réinitialiser les logs d'action au début d'une nouvelle manche
        table.actionLogs = [];
